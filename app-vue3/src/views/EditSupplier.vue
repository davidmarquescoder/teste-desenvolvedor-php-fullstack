...
<script>
import getSupplierById from '../services/suppliers/getSupplierById.js'
import updateSupplier from '../services/suppliers/updateSupplier.js'
...
export default {
  ...
  methods: {
    async fetchSupplierData() {
      const supplierData = await getSupplierById(this.$route.params.id)
      this.formData = supplierData
    },
    async submitForm() {
      await updateSupplier(this.$route.params.id, this.formData)
    }
  },
  async created() {
